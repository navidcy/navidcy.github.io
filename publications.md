...
0. Barnes, A., Shakespeare, C., Hogg, A. McC., and **Constantinou, N. C.** (2025). Rapid topographic scatter of near-inertial waves generated by storms. _J. Phys. Oceanogr._, **55(10)**, 1847-1858. [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;">datasets and notebooks</span>][topographic-NIWs-repo]{:target="_blank"} [<span class="btn btn-info btn-xs{{end}}" style="font-family:sans-serif;">doi</span>][topographic-NIWs-doi]{:target="_blank"} [<span class="btn btn-primary btn-xs{{end}}" style="font-family:sans-serif;">pdf</span>][topographic-NIWs] <span align="right" class='altmetric-embed' data-badge-type="2" data-condensed="true" data-hide-less-than="2" data-doi="10.1175/JPO-D-24-0240.1"></span><br/>


0. Bhagtani, D., Hogg, A. McC., Holmes, R. M., **Constantinou, N. C.**, and Khatri, H. (2025). Asymmetric response of the North Atlantic gyres to the North Atlantic Oscillation. _J. Geophys. Res. Oceans_, **130**, e2024JC021997. [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;">datasets and notebooks</span>][gyres-NAO-repo] [<span class="btn btn-info btn-xs{{end}}" style="font-family:sans-serif;">doi</span>][gyres-NAO-doi]{:target="_blank"} [<span class="btn btn-primary btn-xs{{end}}" style="font-family:sans-serif;">pdf</span>][gyres-NAO] <span align="right" class='altmetric-embed' data-badge-type="2" data-condensed="true" data-hide-less-than="2" data-doi="10.1029/2024JC021997"></span><br/>


0. Ong, E. Q. Y., England, M. H., Doddridge, E. W., and **Constantinou, N. C.** (2025). Transient Antarctic Slope Current response to climate change including meltwater. _Geophys. Res. Lett._, **52**, e2024GL113983. [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;">datasets and notebooks</span>][asc-meltwater-repo] [<span class="btn btn-info btn-xs{{end}}" style="font-family:sans-serif;">doi</span>][asc-meltwater-doi]{:target="_blank"} [<span class="btn btn-primary btn-xs{{end}}" style="font-family:sans-serif;">pdf</span>][asc-meltwater] <span align="right" class='altmetric-embed' data-badge-type="2" data-condensed="true" data-hide-less-than="2" data-doi="10.1029/2024GL113983"></span><br/>
...
(featured on the [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;"><b>issue cover</b></span>][soreview-issuecover-doi]{:target="_blank"}; also read about it in [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;"><b>The Conversation</b></span>][theconversation-so-review]{:target="_blank"})<br/>
...
0. Ong, E. Q. Y., Doddridge, E. W., **Constantinou, N. C.**, Hogg, A. McC. and England, M. H. (2024). Intrinsically episodic Antarctic shelf intrusions of circumpolar deep water via canyons. _J. Phys. Oceanogr._, **54(5)**, 1195-1210. [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;">datasets and notebooks</span>][JPOascintrusions-repo]{:target="_blank"} [<span class="btn btn-info btn-xs{{end}}" style="font-family:sans-serif;">doi</span>][ascintrusions-doi]{:target="_blank"} [<span class="btn btn-primary btn-xs{{end}}" style="font-family:sans-serif;">pdf</span>][ascintrusions] <span align="right" class='altmetric-embed' data-badge-type="2" data-condensed="true" data-hide-less-than="2" data-doi="10.1175/JPO-D-23-0067.1"></span><br/>
...
0. **Constantinou, N. C.** and Parker, J. B. (2018). Magnetic suppression of zonal flows on a beta plane. _Astrophys. J._, **863**, 46. [<span class="btn btn-info btn-xs{{end}}" style="font-family:sans-serif;">doi</span>][magneticZF-doi]{:target="_blank"} [<span class="btn btn-primary btn-xs{{end}}" style="font-family:sans-serif;">pdf</span>][magneticZF] <span align="right" class='altmetric-embed' data-badge-type="2" data-condensed="true" data-doi="10.3847/1538-4357/aace53"></span> <br/>
...
[gyres-NAO-repo]: https://github.com/dhruvbhagtani/NAO-vorticity-budget-gyres
[JPOascintrusions-repo]: https://github.com/ongqingyee/idealised-ASC
...
[topographic-NIWs-doi]: https://doi.org/10.1175/JPO-D-24-0240.1
...
[weno-ILES-doi]: https://doi.org/10.1029/2023MS004130
[review-multiscale-SO-doi]: https://doi.org/10.1029/2022RG000781
[speedyweather-doi]: https://doi.org/10.21105/joss.06323
...
[arXiv:2503.12845]: https://arxiv.org/abs/2503.12845
