...
(appeared on the [<span class="btn btn-default btn-xs{{end}}" style="font-family:sans-serif;"><b>issue cover</b></span>][betaplane-surface-waves-cover]{:target="_blank"})
...
[betaplane-surface-waves-cover]: https://static.cambridge.org/covers/FLM_0_1020_0/cover.jpg?send-default-cover=false&send-full-size-image=true
